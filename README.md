...
bashpip install streamlit pandas numpy matplotlib plotly PyPDF2 folium streamlit-folium tensorflow
Optional Dependencies
For full functionality, install:
bashpip install scikit-learn
Clone the Repository
bashgit clone https://github.com/amrutaVelamuri/earth_prize_final.git
...
bashpython train_lstm_model.py
This will:
...
Start with PDF Analyzer (Optional)
...
Geographic Scope: Climate model trained on Bangladesh data; predictions most accurate for South Asian monsoon climates
Temporal Scope: Forecasts limited to 24 months
Model Assumptions: Assumes consistent maintenance and operational efficiency
Data Requirements: LSTM requires historical climate patterns; may need retraining for different regions
